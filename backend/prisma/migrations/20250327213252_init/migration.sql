...
-- CreateEnum
CREATE TYPE "AnnotationType" AS ENUM ('MARKER', 'MEASUREMENT', 'TEXT', 'DRAWING');

-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('APPOINTMENT', 'MESSAGE', 'SHARE', 'SYSTEM');
...
-- CreateEnum
CREATE TYPE "ProviderSpecialty" AS ENUM ('GENERAL', 'RADIOLOGY', 'CARDIOLOGY', 'NEUROLOGY', 'ORTHOPEDICS', 'OTHER');
