...
class PatientController {
  getPatientProfile = catchAsync(async (req: AuthenticatedRequest, res: Response) => {
  ...
  updatePatientProfile = catchAsync(async (req: AuthenticatedRequest, res: Response) => {
  ...
  getPatientMedicalRecords = catchAsync(async (req: AuthenticatedRequest, res: Response) => {
  ...
  addMedicalRecord = catchAsync(async (req: AuthenticatedRequest, res: Response) => {
    const { iv, authTag, encryptedData } = req.body;
    const decryptedData = req.body.encrypted ? decryptData(encryptedData, iv, authTag) : req.body;
  ...
  getPatientHealthMetrics = catchAsync(async (req: AuthenticatedRequest, res: Response) => {
  ...
  addHealthMetric = catchAsync(async (req: AuthenticatedRequest, res: Response) => {
    const { iv, authTag, encryptedData } = req.body;
    const decryptedData = req.body.encrypted ? decryptData(encryptedData, iv, authTag) : req.body;
    ...
    const metric = await prisma.healthMetric.create({
      data: {
        ...
        patientId: req.user.id,
        timestamp: new Date(),
        type: decryptedData.type as HealthMetricType
      }
    });
  ...
  getPatientProviders = catchAsync(async (req: AuthenticatedRequest, res: Response) => {
  ...
  addProviderRelationship = catchAsync(async (req: AuthenticatedRequest, res: Response) => {
