 ...
 */
export const getPatientSettings = catchAsync(async (req: AuthenticatedRequest, res: Response) => {
 ...
 */
export const updatePatientSettings = catchAsync(async (req: AuthenticatedRequest, res: Response) => {
  const userId = req.user.id;
  ...
  const currentWorkingHours = (existingSettings?.workingHours as any) || {};
  ...
  const patientSettings = {
    personalInfo: (updatedWorkingHours.personalInfo || {}) as any,
    privacy: (updatedWorkingHours.patientSettings?.privacy || {}) as any,
    notifications: (updatedWorkingHours.patientSettings?.notifications || {}) as any,
    communication: (updatedWorkingHours.patientSettings?.communication || {}) as any,
  };
