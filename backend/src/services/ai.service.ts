...
import type { Role, ChatSession, ChatMessage } from '@prisma/client';
...
export class AIService {
  ...
  private getSystemMessageForRole(role: Role): string {
  ...
  private extractMedicalContext(response: string): any {
