...
export class EmailService {
    ...
    async sendImageShareNotification(recipientEmail, senderName, shareLink, expiresIn) {
    ...
    async sendNewMessageNotification(recipientEmail, senderName) {
        await this.sendEmail({
            to: recipientEmail,
    ...
    async sendAppointmentCompletedEmail(appointment) {
        const { patient, doctor } = appointment;
        await this.sendEmail({
            to: patient.email,
    ...
    async sendAppointmentCancelledEmail(appointment) {
        const { patient, doctor } = appointment;
        await this.sendEmail({
            to: patient.email,
    ...
    async sendAppointmentNoShowEmail(appointment) {
        const { patient, doctor } = appointment;
        await this.sendEmail({
            to: patient.email,
