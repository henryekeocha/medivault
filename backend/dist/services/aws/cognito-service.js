import { CognitoIdentityProviderClient, InitiateAuthCommand, SignUpCommand, ConfirmSignUpCommand, ForgotPasswordCommand, ConfirmForgotPasswordCommand, GetUserCommand, UpdateUserAttributesCommand, AdminCreateUserCommand, AdminSetUserPasswordCommand, AdminUpdateUserAttributesCommand, AdminDisableUserCommand, AdminEnableUserCommand, ResendConfirmationCodeCommand, GlobalSignOutCommand, AdminAddUserToGroupCommand, AdminGetUserCommand, } from '@aws-sdk/client-cognito-identity-provider';
/**
...
export class CognitoService {
     ...
     * @returns Result from Cognito
     */
    async adminSetUserPassword(email, password, permanent = true) {
        try {
     ...
     * @returns Result from Cognito
     */
    async adminAddUserToGroup(email, groupName) {
        try {
