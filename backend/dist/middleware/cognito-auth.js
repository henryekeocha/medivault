 ...
 */
export async function authenticateCognitoRequest(req) {
    try {
        ...
        return NextResponse.json({ error: 'Unauthorized', message: 'Authentication failed' }, { status: 401 });
    }
}
/**
 ...
 */
export function checkUserRole(req, allowedRoles) {
