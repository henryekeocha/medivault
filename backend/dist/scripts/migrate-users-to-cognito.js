...
async function migrateUser(user) {
    try {
        ...
        const result = await cognitoService.adminCreateUser(user.email, tempPassword, userAttributes);
        ...
        if (user.password) {
            await cognitoService.adminSetUserPassword(user.email, tempPassword, true // Set as permanent
            );
        }
...
//# sourceMappingURL=migrate-users-to-cognito.js.map