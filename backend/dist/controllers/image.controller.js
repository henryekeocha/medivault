...
export const uploadImage = catchAsync(async (req, res) => {
    ...
    // Generate signed URL
    const s3Url = await getSignedUrl(s3Client, new PutObjectCommand({
        Bucket: process.env.AWS_S3_BUCKET,
        Key: s3Key,
...
export const updateImageMetadata = catchAsync(async (req, res) => {
...
// Share image
export const shareImage = catchAsync(async (req, res) => {
...
// Get shared image
export const getSharedImage = catchAsync(async (req, res) => {
...
// Delete annotation
export const deleteAnnotation = catchAsync(async (req, res) => {
    const image = await prisma.image.findUnique({
        where: {
            id: req.params.id,
        },
