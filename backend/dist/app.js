...
app.use(helmet({
    contentSecurityPolicy: {
        directives: {
            ...
            connectSrc: ["'self'", process.env.CORS_ORIGIN, "ws:", "wss:", "127.0.0.1:*", "localhost:*"].filter(Boolean),
...
app.post('/api/auth/sync/:clerkId', async (req, res) => {
    try {
...
app.use('/api/v1/patient/settings', bypassAuth, patientSettingsRoutes);
